...
//     return tempData.map((el) => {
//       const { ...temp } = el;
//       temp.dateTime = temp.dateTime?.toString();
//       return temp;
//     });
//   }
// };
...
//   /* eslint-disable */
//   useEffect(() => {
//     const record = data.find((el) => typeof el.dateTime === 'object');
//     if (record) {
//       edit(record);
//     }
//   }, [data]);
...
//     setDateStr(record.dateTime);
//     rowRef.current.type = record.type;
//   };

//   const cancel = () => {
//     setEditingKey('');
//     let dataToMap = data.filter((el) => typeof el.dateTime === 'object');
...
//         originItem.dateTime = moment(dateStr, dateFormat);
//         row.dateTime = dateStr;
//         originRow.dateTime = moment(dateStr, dateFormat);
